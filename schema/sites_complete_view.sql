...
COMMENT ON VIEW public.sites_complete IS 'Optimized view combining all site-related tables into a single query. Specialty data embedded as JSONB arrays via FK joins. burro aliased to burrito; unused site fields removed; spec FK columns normalized to spec_id_N. snacks_yes/snacks_perc added in migration 023.';
