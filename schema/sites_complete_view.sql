...
--
-- Last updated: Migration 013 (added missing burro_perc)
...
COMMENT ON VIEW public.sites_complete IS 'Optimized view combining all site-related tables into a single query. Specialty data embedded as JSONB arrays via FK joins.';
