-- Migration: Create optimized view for site data
-- This view joins all site-related tables (sites, descriptions, menu, hours, salsa, protein)
-- into a single queryable view to reduce network requests from 6 to 1
--
...
-- Create the complete sites view
