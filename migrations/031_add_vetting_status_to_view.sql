...
--
-- Last updated: Migration 031 (added vetting_status/source/source_url)
...
SELECT
  ...
  jsonb_build_object(
    ...
    'snacks_yes', m.snacks_yes,
    'quesadilla_yes', m.quesadilla_yes,
    'burrito_perc', m.burro_perc,
    ...
    'snacks_perc', m.snacks_perc,
    'quesadilla_perc', m.quesadilla_perc,
...
COMMENT ON VIEW public.sites_complete IS 'Optimized view combining all site-related tables into a single query. Specialty data embedded as JSONB arrays via FK joins. burro aliased to burrito; unused site fields removed; spec FK columns normalized to spec_id_N. snacks_yes/snacks_perc added in migration 023. quesadilla_yes/quesadilla_perc added in migration 026. vetting_status/source/source_url added in migration 031 (unvetted spots feature).';
