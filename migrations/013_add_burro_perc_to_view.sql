-- Migration: Add missing burro_perc to sites_complete view
-- The burro_yes field was included but burro_perc was accidentally omitted,
-- causing burritos to never appear in the menu radar chart.
--
...
COMMENT ON VIEW public.sites_complete IS 'Optimized view combining all site-related tables into a single query. Specialty data is embedded as JSONB arrays via FK joins. Fixed: added missing burro_perc field.';
